...
define(function() {
    ...
    // =======================================================================
    function executeOnFrame(
        inLayer,
        inFunction)
    {
        var lastFrame = inDom.currentFrameNum,
            result;
        
        if (inFrame != lastFrame) {
            inDom.currentFrameNum = inFrame;
        }
        
        result = inFunction();

        if (inDom.currentFrameNum != lastFrame) {
            inDom.currentFrameNum = lastFrame;
        }
...
//		inFrame)
//	{
//		lastFrame = inDom.currentFrameNum;
//		
//		if (inFrame != lastFrame) {
//			inDom.currentFrameNum = inFrame;
//		}
//	}
    ...
    // =======================================================================
    function getLayerPropertyOnFrame(
        inLayer,
        inProperty)
    {
        return executeOnFrame(inLayer, function() {
            return inLayer._dom.frames[inLayer._frameIndex].layers[inLayer.index][inProperty];
        });
        
        var value = inDom.frames[inFrame].layers[inLayer][inProperty];
    ...
    /**
        ...
        @param {Number} [inFrameIndex=currentFrameNum] A 0-based index of the
            frame for which the `LayerTree` should be constructed, since the
            sub-layer structure can be different on different frames. 
    ...
    */
        ...
        inFrameIndex)
    {
        ...
        if (typeof inFrameIndex == "number") {
            this._frameIndex = inFrameIndex;
        } else {
    ...
    LayerTree.prototype = /** @lends module:layers.LayerTree.prototype */ {
        ...
        */
        ...
        /**
            ...
            of a layer to set the document's `currentLayerNum` value.
...
//		this._frameIndex = this._dom.currentFrameNum;
    ...
    Layer.prototype = /** @lends module:layers.Layer.prototype */ {
        ...
        */
        ...
        // ===================================================================
        _executeOnFrame: function(
            inFunction)
        {
            var lastFrame = this._dom.currentFrameNum,
                result;

            if (this._frameIndex != lastFrame) {
                this._dom.currentFrameNum = this._frameIndex;
            }

            result = inFunction.call(this);

            if (this._dom.currentFrameNum != lastFrame) {
                this._dom.currentFrameNum = lastFrame;
            }
        ...
        // ===================================================================
        _getPropertyOnFrame: function(
            inProperty)
        {
            return this._executeOnFrame(function() {
                return this._dom.frames[this._frameIndex].layers[this.index][inProperty];
            });
        },
        ...
        */
        ...
        {
            if (this.index > -1) {
                return this._getPropertyOnFrame("name");
//				return getLayerPropertyOnFrame(this._dom, this._frameIndex, this.index, "name");
//				return this._dom.frames[this._frameIndex].layers[this.index].name;
//				return this._dom.layers[this.index].name;
            } else {
                return "[[ROOT]]";
            }
        },
        ...
        {
            if (this.index > -1) {
                this._dom.layers[this.index].name = inName;
            }
        },
...
//				executeOnFrame(this._dom, this._frameIndex);
//				var layer = this._dom.layers[this.index];
//				restoreFrame(this._dom);
//				return layer;
//				return this._dom.layers[this.index];
            }
        },
        ...
        */
        get elements()
        {
            return getLayerPropertyOnFrame(this, "elements");
//			return this.layer.frames[this._frameIndex].elements;
        ...
        */
        ...
        /**
            ...
            list of immediate sub-layers or by its name.  
        ...
        */
        get visible()
        {
            if (this.index == -1) {
                ...
                return this._getPropertyOnFrame("visible");
//				return getLayerPropertyOnFrame(this, "visible");
//				return this.layer.frames[this._frameIndex].visible;
            }
        },
        set visible(
            inVisible)
        ...
        */
        get locked()
        {
            if (this.index == -1) {
                ...
                return this._getPropertyOnFrame("locked");
//				return getLayerPropertyOnFrame(this, "locked");
//				return getLayerPropertyOnFrame(this._dom, this._frameIndex, this.index, "locked");
//log("locked", this._dom.frames[this._frameIndex].layers[this.index].locked, this._frameIndex, this.index);				
//				return this._dom.frames[this._frameIndex].layers[this.index].locked;
//				return this.layer.frames[this._frameIndex].locked;
            }
        },
        set locked(
            inLocked)
        ...
        */
        ...
        /**
            ...
            After calling `layer.remove()`, you should call `refresh()` on the 
            `LayerTree` that contains the `Layer`.  
        */
        remove: function()
        {
            this._executeOnFrame(function() {
//			executeOnFrame(this._dom, this._frameIndex);
//			var layer = this._dom.layers[this.index];
//			restoreFrame(this._dom);
        ...
        // ===================================================================
        /**
            Deletes all the elements on the layer in this state.
        */
        deleteElements: function()
        {
            this._executeOnFrame(function() {
            this._dom.selectAllOnLayer(this.index, false, false);
        ...
        /**
            ...
            @param {Boolean} inLocked The value to set the visible state to.
        */
