    ...
    LayerTree.prototype = /** @lends module:layers.LayerTree.prototype */ {
        ...
        */
        ...
        /**
            ...
            document.  Set this to the index or name of a layer to set the
            document's `currentLayerNum` value to that layer's top-level
            ancestor.
    ...
    Layer.prototype = /** @lends module:layers.Layer.prototype */ {
        ...
        */
        ...
        /**
            ...
            reverse order of the `elemsandsublayers` array.
        ...
        */
        ...
        // ===================================================================
        /**
            An array of the Fireworks elements and sub-layers on the layer.
