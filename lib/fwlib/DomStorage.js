    ...
    JSON) 
{
    ...
    /**
        ...
        And to make things worse, each property on `dom.pngText` is limited to 
        ...
        modified on a `DomStorage` instance.  Also, the data is stored on the
        `dom.pngText` of the first page in the document, as each page in a 
        document has its own copy of the property.  If the user deletes the first
        page or rearranges it, the data will be lost.

        @param {String} inName The name of the preference.
        @param {Object} [inDefaults] An optional object containing default 
